...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between gap-2 whitespace-nowrap rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium shadow-sm ring-offset-background',
